...
class Fraction {
	public:
		...
		// generates a fraction which is a/b
		
		Fraction(int a);
		// generates a fraction which is a/1
		
		Fraction();
		// generates a fraction which is 0/1. i.e. 0
		...
		void reduce();
		// reduces this fraction to simplest form. For instance,
		...
		friend Fraction operator -(const Fraction& f1, const Fraction& f2);
		// returns the difference of f1 and f2,
		// the result is reduced
		...
		friend Fraction operator /(const Fraction& f1, const Fraction& f2);
		// returns the quotient of f1 and f2,
		// the result is reduced
		...
		// outputs a Fraction f in form of a/b
...
/* function definitions for test one */

Fraction::Fraction(int a, int b) {
	/* generates a fraction in the form a/b (where a > 0 and b < 0). */
...
Fraction::Fraction(int a): num(a), den(1) {
	/* generates a fraction in the form a/1. */
}

Fraction::Fraction(): num(0), den(1) {
	/* generates the fraction 0/1 (i.e. 0). */
}
...
double test1();
// tests constructors and get methods.
// worth 1.5 points

/* end of function definitions for test one */


/* function definitions for test two */

void Fraction::reduce() {
	// reduces this fraction to simplest form. For instance,
	// 2/4 will be reduced to 1/2

	const int divisor = gcd();
	num /= divisor;
	den /= divisor;
}
...
double test2();
// tests neg, reduce, and reciprocal functions.
// All these functions worth 1.5 points

/* end of function definitions for test two */


/* function definitions for test three */

Fraction operator + (const Fraction& f1, const Fraction& f2) {
	// returns the sum of f1 and f2,
	// the result is reduced

	const int commonDen = f1.den * f2.den;
	return Fraction((f1.num * f2.den) + (f2.num * f1.den), commonDen);
}
...
double test3();
// tests add, sub, mul, and div functions.
// All these functions worth 3 points

/* end of function definitions for test three */


/* function definitions for test four */
...
double test4();
// tests less, greater, equal, less_or_equal, greater_or_equal,
// not_equal. All these functions worth 2 points

/* end of function definitions for test four */


/* function definitions for test five */
...
double test5();
// tests input and output function. This two functions worth 1 points

/* end of function definitions for test five */
